/*
JD_COOKIE 同步工具，JD1 ---> BOXJS
40 * * * https://raw.githubusercontent.com/axtyet/ios/main/QuantumultX/Fokit/scripts/jd1_sync_box.js
*/

const $ = new API('ql', true);

const title = '🐉 JD_COOKIE 同步 (JD1)';
...
async function getScriptUrl() {
  const response = await $.http.get({
    url: 'https://raw.githubusercontent.com/axtyet/ios/main/QuantumultX/Fokit/scripts/jd1_api.js',
  })
