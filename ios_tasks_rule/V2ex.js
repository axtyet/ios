...
async function getCookie() {
    if ($request && $request.method != 'OPTIONS') {
        const tokenValue = $request.headers['access-token'] || $request.headers['authorization'] || $request.headers['Authorization'] || $request.headers['cookie'] || $request.headers['Cookie'];
        if (tokenValue) {
